      ...
      <div class="top-section">
        ...
        <div class="user-info-card">
          <div class="avatar-wrapper">
            ...
            <h3 class="user-name">{{ userInfo?.realName || '系统管理员' }}</h3>
            <div class="user-email">{{ userInfo?.email || 'admin@system.edu.cn' }}</div>
          </div>
          <div class="info-list">
            <div class="info-item">
            ...
            <div class="info-item">
              ...
              <span class="value">{{ userInfo?.role || '超级管理员' }}</span>
            </div>
            <div class="info-item">
              <span class="label">手机号</span>
              <span class="value">{{ profileForm.phone || '13800138000' }}</span>
            </div>
            <div class="info-item">
              <span class="label">邮箱</span>
              <span class="value">{{ profileForm.email || 'admin@system.edu.cn' }}</span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
              ...
              <span class="value">2026-05-02 20:45</span>
            </div>
          </div>
        </div>
