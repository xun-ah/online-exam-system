    ...
    <div class="main-container">
      ...
      <div class="sidebar" :class="{ collapsed: isCollapsed }">
        <el-menu
          ...
          :default-openeds="['/admin/dashboard']"
...
import { User, SwitchButton, FullScreen, Refresh, Fold, Expand, DataAnalysis, Avatar, School, Reading, Collection, TrendCharts, Document, Lock } from '@element-plus/icons-vue'
