        ...
        <div class="right-actions">
          ...
          <el-dropdown @command="handleCommand">
            <span class="user-info">
              ...
              <span>{{ userInfo?.realName || userInfo?.username || '教师' }}</span>
            </span>
            <template #dropdown>
              <el-dropdown-menu>
    ...
    <div class="main-container">
      ...
      <div class="sidebar" :class="{ collapsed: isCollapsed }">
        <el-menu
          ...
          :default-openeds="['/teacher/dashboard']"
...
import { User, SwitchButton, FullScreen, Refresh, Fold, Expand, DataAnalysis, Collection, Document, Timer, EditPen } from '@element-plus/icons-vue'
...
// 刷新页面 - 使用浏览器原生刷新，由于已删除main.js中清除localStorage的代码，刷新后登录状态会保留
const refreshPage = () => {
